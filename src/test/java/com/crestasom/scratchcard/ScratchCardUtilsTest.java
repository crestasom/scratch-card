...
public class ScratchCardUtilsTest {
    ...
    private CurrentMatrix matrixWith(String[][] values, long bet, List<String> bonusSymbols) {
        CurrentMatrix matrix = new CurrentMatrix(3, 3);
    ...
    void testSameSymbol3Times() {
        ...
        CurrentMatrix matrix = matrixWith(values, 100, null);
    ...
    void testWithBonusSymbols() {
        ...
        CurrentMatrix matrix = matrixWith(values, 100, Arrays.asList("10x", "+1000", "5x", "MISS"));
        ScratchCardUtils.calculate(config, matrix);
